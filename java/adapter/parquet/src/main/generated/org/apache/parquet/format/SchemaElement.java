...
public class SchemaElement implements org.apache.thrift.TBase<SchemaElement, SchemaElement._Fields>, java.io.Serializable, Cloneable, Comparable<SchemaElement> {
   ...
   * @see FieldRepetitionType
   */
  public SchemaElement setRepetition_type(@org.apache.thrift.annotation.Nullable FieldRepetitionType repetition_type) {
   ...
   * @see ConvertedType
   */
  public SchemaElement setConverted_type(@org.apache.thrift.annotation.Nullable ConvertedType converted_type) {
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRepetition_type()) ? 131071 : 524287);
  ...
  public int compareTo(SchemaElement other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetType_length(), other.isSetType_length());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetType_length()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRepetition_type(), other.isSetRepetition_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRepetition_type()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetConverted_type(), other.isSetConverted_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetConverted_type()) {
