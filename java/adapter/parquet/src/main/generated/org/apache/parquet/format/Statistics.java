...
public class Statistics implements org.apache.thrift.TBase<Statistics, Statistics._Fields>, java.io.Serializable, Cloneable, Comparable<Statistics> {
  ...
  public java.nio.ByteBuffer bufferForMax_value() {
  ...
  public Statistics setMax_value(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer max_value) {
  ...
  public java.nio.ByteBuffer bufferForMin_value() {
  ...
  public Statistics setMin_value(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer min_value) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case MAX_VALUE:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          setMax_value((byte[])value);
        } else {
          setMax_value((java.nio.ByteBuffer)value);
        }
      }
      break;
    ...
    case MIN_VALUE:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          setMin_value((byte[])value);
        } else {
          setMin_value((java.nio.ByteBuffer)value);
        }
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMax_value()) ? 131071 : 524287);
    if (isSetMax_value())
      hashCode = hashCode * 8191 + max_value.hashCode();

    hashCode = hashCode * 8191 + ((isSetMin_value()) ? 131071 : 524287);
    if (isSetMin_value())
  ...
  public int compareTo(Statistics other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNull_count(), other.isSetNull_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNull_count()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDistinct_count(), other.isSetDistinct_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDistinct_count()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMax_value(), other.isSetMax_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMax_value()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetMin_value(), other.isSetMin_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMin_value()) {
