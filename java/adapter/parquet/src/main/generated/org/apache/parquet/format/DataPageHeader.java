...
public class DataPageHeader implements org.apache.thrift.TBase<DataPageHeader, DataPageHeader._Fields>, java.io.Serializable, Cloneable, Comparable<DataPageHeader> {
   ...
   * @see Encoding
   */
  public DataPageHeader setDefinition_level_encoding(@org.apache.thrift.annotation.Nullable Encoding definition_level_encoding) {
    this.definition_level_encoding = definition_level_encoding;
    return this;
  }
   ...
   * @see Encoding
   */
  public DataPageHeader setRepetition_level_encoding(@org.apache.thrift.annotation.Nullable Encoding repetition_level_encoding) {
    this.repetition_level_encoding = repetition_level_encoding;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDefinition_level_encoding()) ? 131071 : 524287);
    if (isSetDefinition_level_encoding())
      hashCode = hashCode * 8191 + definition_level_encoding.getValue();

    hashCode = hashCode * 8191 + ((isSetRepetition_level_encoding()) ? 131071 : 524287);
  ...
  public int compareTo(DataPageHeader other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDefinition_level_encoding(), other.isSetDefinition_level_encoding());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDefinition_level_encoding()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRepetition_level_encoding(), other.isSetRepetition_level_encoding());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRepetition_level_encoding()) {
