...
public class PageHeader implements org.apache.thrift.TBase<PageHeader, PageHeader._Fields>, java.io.Serializable, Cloneable, Comparable<PageHeader> {
  ...
  public PageHeader setData_page_header(@org.apache.thrift.annotation.Nullable DataPageHeader data_page_header) {
  ...
  public PageHeader setIndex_page_header(@org.apache.thrift.annotation.Nullable IndexPageHeader index_page_header) {
  ...
  public PageHeader setDictionary_page_header(@org.apache.thrift.annotation.Nullable DictionaryPageHeader dictionary_page_header) {
  ...
  public PageHeader setData_page_header_v2(@org.apache.thrift.annotation.Nullable DataPageHeaderV2 data_page_header_v2) {
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetData_page_header_v2()) ? 131071 : 524287);
  ...
  public int compareTo(PageHeader other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetUncompressed_page_size(), other.isSetUncompressed_page_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetCompressed_page_size(), other.isSetCompressed_page_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetData_page_header(), other.isSetData_page_header());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetData_page_header()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIndex_page_header(), other.isSetIndex_page_header());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIndex_page_header()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDictionary_page_header(), other.isSetDictionary_page_header());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDictionary_page_header()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetData_page_header_v2(), other.isSetData_page_header_v2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetData_page_header_v2()) {
