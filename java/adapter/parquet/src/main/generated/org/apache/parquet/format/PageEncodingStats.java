...
public class PageEncodingStats implements org.apache.thrift.TBase<PageEncodingStats, PageEncodingStats._Fields>, java.io.Serializable, Cloneable, Comparable<PageEncodingStats> {
   ...
   * @see PageType
   */
  public PageEncodingStats setPage_type(@org.apache.thrift.annotation.Nullable PageType page_type) {
    this.page_type = page_type;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPage_type()) ? 131071 : 524287);
    if (isSetPage_type())
  ...
  public int compareTo(PageEncodingStats other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPage_type(), other.isSetPage_type());
    if (lastComparison != 0) {
