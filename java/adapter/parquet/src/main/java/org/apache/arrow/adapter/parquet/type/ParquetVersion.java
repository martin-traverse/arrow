 ...
 *
 * ParquetVersion governs which data types are allowed and how they
...
public enum ParquetVersion {
   ...
   * Use PARQUET_2_4 or PARQUET_2_6 for fine-grained feature selection.
   */
  @Deprecated
  PARQUET_2_0,
   ...
   *
   * This enables UINT32 as well as logical types which don't have a corresponding converted type.
   ...
   *
   * This enables the NANOS time unit in addition to the PARQUET_2_4 features.
   ...
   *
   * This value is equal to the greatest 2.x version supported by this library.
   */
  public static final ParquetVersion PARQUET_2_LATEST = PARQUET_2_6;
}
